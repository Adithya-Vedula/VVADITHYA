print("============= RESTART: " + r"c:\Users\class11\Documents\VVADITHYA\CODE\ex27.py" + " ============")
...
# -------------------------------------------------------------------
theLabels=[]
artarrange=sorted(ArtistList, key=lambda x: x[-1],reverse=True)

for i in range(len(ArtistList)):
    label=ArtistList[i][1][0]+ArtistList[i][0][0]+str(ArtistList[i][2])
